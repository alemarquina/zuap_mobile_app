...
class BatteryQrScannerScreen extends StatefulWidget {
  const BatteryQrScannerScreen({super.key});

  @override
  State<BatteryQrScannerScreen> createState() => _BatteryQrScannerScreenState();
}

class _BatteryQrScannerScreenState extends State<BatteryQrScannerScreen> {
  ...
  void _simulateScan() {
    if (isScanning) {
      ...
      // Simulate QR code scan and navigate to success screen
      Navigator.pushReplacementNamed(
        context,
        '/swap_success_screen',
      );
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Text(
                    'Escanea el código de la batería',
