// lib/features/vehicles/presentation/screens/qr_scanner_screen.dart

import 'package:flutter/material.dart';
import 'package:mobile_scanner/mobile_scanner.dart';
import 'package:zuap_mobile_app/shared/theme/app_theme.dart';

class VehicleLinkScannerScreen extends StatefulWidget {
  const VehicleLinkScannerScreen({super.key});

  @override
  State<VehicleLinkScannerScreen> createState() => _VehicleLinkScannerScreenState();
}

class _VehicleLinkScannerScreenState extends State<VehicleLinkScannerScreen> {
  ...
  void _onDetect(BarcodeCapture capture) {
    if (isScanning && capture.barcodes.isNotEmpty) {
      ...
      if (code != null) {
        ...
        // Navigate to vehicle link details screen
        Navigator.pushReplacementNamed(
          context,
          '/vehicle_link_details_screen',
          arguments: code,
        );
      }
    }
  ...
  void _simulateScan() {
    if (isScanning) {
      ...
      Navigator.pushReplacementNamed(
        context,
        '/vehicle_link_details_screen',
        arguments: 'SIMULATED_QR_CODE_MC002',
      );
    }
  }
